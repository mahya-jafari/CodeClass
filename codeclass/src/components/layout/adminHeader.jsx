...
import { useGetAdminProfileQuery } from "../../store/api/adminApis"; 
        ...
        <div className="flex items-center gap-3">
          <div className="text-left hidden sm:block">
            <p className="text-sm font-semibold text-gray-800">
              {profile?.name || "مدیر سیستم"}
            </p>
            <p className="text-xs text-gray-500">{profile?.role || "ادمین"}</p>
          </div>
          <img
            src={profile?.avatar || "https://via.placeholder.com/40x40?text=Admin"}
            alt="Admin"
