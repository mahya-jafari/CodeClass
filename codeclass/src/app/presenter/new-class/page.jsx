...
import { useCreateClassMutation } from "../../../store/api/presenterApis";
              ...
              <form className="space-y-5 sm:space-y-6" onSubmit={handleSubmit}>
                <div>
                  ...
                  <input
                    ...
                    placeholder="مثال: آموزش React از صفر تا پیشرفته"
                    className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:border-blue-500 text-sm"
                  />
                </div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    placeholder="توضیحات کامل در مورد محتوای کلاس..."
                    className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:border-blue-500 resize-none text-sm"
                  />
                </div>
                ...
                <div className="flex flex-col sm:flex-row gap-3 pt-2">
                  <button
                    type="submit"
                    className="bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-xl font-medium transition text-sm"
                  >
                    ایجاد کلاس
                  </button>
                  <button
                    type="button"
                    className="border border-gray-300 text-gray-700 px-6 py-3 rounded-xl font-medium hover:bg-gray-50 transition text-sm"
                  >
                    انصراف
                  </button>
                </div>
