      ...
      <main className="flex-1 lg:mr-64 transition-all duration-300 flex flex-col h-screen">
          ...
          {messages.map((m) => (
            ...
            >
              ...
              >
                {m.file && (
                  <a
                    ...
                    className={`flex items-center gap-2 mb-2 p-2 rounded-xl text-xs ${
                      m.fromMe ? "bg-blue-500" : "bg-gray-50"
                    }`}
                  >
                    <FiFile size={14} />
                ...
                <p className={`text-[10px] mt-1 ${m.fromMe ? "text-blue-100" : "text-gray-400"}`}>
                  {m.time}
                </p>
              </div>
            </div>
        ...
        <div className="bg-white border-t p-3 flex items-center gap-2 flex-shrink-0">
          ...
          <input
            ...
            className="flex-1 px-4 py-2.5 border rounded-xl text-sm focus:outline-none focus:border-blue-500"
          />
          <button
            onClick={send}
            className="w-11 h-11 bg-blue-600 hover:bg-blue-700 text-white rounded-xl flex items-center justify-center"
          >
            <FiSend size={18} />
          </button>
        </div>
