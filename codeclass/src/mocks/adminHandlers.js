...
export const handlers = [
    ...
    http.get(`${API}/admin/finance`, () => HttpResponse.json({
      summary: [
        ...
        { title: "درآمد ماهانه", value: "۱۲۴.۵M", color: "text-green-600" },
      ],
      withdrawals: [
      ...
      recentTransactions: [
        { id: 1, title: "فروش کلاس React", amount: 4500000, type: "درآمد", date: "۱۴۰۵/۰۲/۰۸", status: "completed" },
        { id: 2, title: "فروش کلاس Python", amount: 3200000, type: "درآمد", date: "۱۴۰۵/۰۲/۰۷", status: "completed" },
        { id: 3, title: "برداشت استاد علی", amount: 2500000, type: "برداشت", date: "۱۴۰۵/۰۲/۰۵", status: "pending" },
      ],
    })),
